#' Generates report after training
#'
#' @param output_format Format of output file ('pdf_document', 'html_document' or both).
#' @param check_data If TRUE, prints results of check_data() function.
#' @param output_dir The path where the report will be saved, by default working
#' directory.
  ...
  function(train_output,
    ...
    rmarkdown::render(
      ...
      params        = list(
        ...
        score          = train_output$ranked_list,
        best_models    = train_output$best_models,
