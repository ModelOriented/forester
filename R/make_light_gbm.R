...
#'
#' Function \code{make_light_gbm} automates the process of applying LightGBM model
#' for a dataset and simutaneously creats explainer from the use of DALEX package.
...
#' library(DALEX)
#' data("iris")
#' EXPLAINER <- make_light_gbm(iris,"Petal.Length",type="regression")
#'
#' ## Variable importance
...
#' titanic_explainer <- make_light_gbm(titanic_imputed, "survived", "classification")
#'
